      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 gap-6">
          <Link to="/" className="flex items-center gap-2.5 shrink-0" data-testid="logo-link">
            <img src="/logo.jpeg" alt="Tendinha do Saber" className="w-11 h-11 rounded-md object-cover" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center gap-2.5 mb-4">
            <img src="/logo.jpeg" alt="Tendinha do Saber" className="w-11 h-11 rounded-md object-cover bg-white" />
            <div>
